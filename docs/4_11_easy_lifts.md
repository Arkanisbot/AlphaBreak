...
14. ~~**Probability of Profit** — Black-Scholes PoP calcs for ATM and full chain. Pro-gated with colored badges.~~
15. ~~**Rate Limiting Tuning** — Per-user JWT key function, per-endpoint limits on analyze (60/min), auth (5-10/min), dashboard (30/min).~~
16. ~~**Query Optimization** — 25 indexes across 17 tables applied to production DB.~~
17. ~~**Insider Trading Signals** — SEC EDGAR Form 4 parsing, buy/sell signals with net sentiment. Pro-gated.~~
18. ~~**Unusual Options Activity** — Volume/OI detection + sweep detection with premium summary. Pro-gated.~~
19. ~~**News NLP Sentiment Scoring** — VADER scoring with headline badges and sentiment bar. Pro-gated.~~
